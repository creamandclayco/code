...
(function() {
  ...
  //SHOPPING CART
    ...
    function renderShoppingCart(){
      ...
      if (cartData.length === 0){
        ...
        document.querySelector('.shopping_cart_total').style.display = "none";
        document.querySelector('.shopping_cart_btn').style.display = "none";
        document.querySelector('.shopping_cart_row-labels').style.display = "none";
  ...
  //4. Watch for form success message
    ...
    function showCustomSuccessMessage(){
      var customSuccessMessage = document.querySelector('.custom-success');
      if (customSuccessMessage){
        customSuccessMessage.style.display = "flex";
      }
    }
