...
let ethereal_image = document.querySelector(".shop_view_image-ethereal"); 
let romantic_image = document.querySelector(".shop_view_image-romantic");
let classic_image = document.querySelector(".shop_view_image-classic");
let poetic_image = document.querySelector(".shop_view_image-poetic");
